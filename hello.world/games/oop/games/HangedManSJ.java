...
public class HangedManSJ {
    ...
    /*
     * Le point d'entrée, réduit au minimum
     * comme cela devrait être la plupart du temps.
     ...
     * propose aux joueurs de continuer ou non.
     * La fonction choisit le mot à deviner
     * parmi la liste des mots possibles, en utilisant
     * un nombre généré aléatoirement. Voir la
    ...
    /*
     * La fonction initialise le jeu pour le
     * mot choisi, donné par son index dans
     * le tableau des mots.
     */
    ...
    /*
     * Une fonction pour savoir si le mot actuel
     * a été deviné ou non. Renvoie true
    ...
    /*
     * Une fonction pour jouer une partie, après qu'un mot
     * ait été choisi. Cette fonction permettra seulement
